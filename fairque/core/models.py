"""Core models for FairQueue: Priority, and Task."""
...
class Task(Executable):
    ...
    def from_redis_dict(cls, data: Dict[str, str]) -> "Task":
        ...
        try:
            ...
            from fairque.core.exceptions import TaskSerializationError
            raise TaskSerializationError(f"Failed to deserialize task from Redis data: {e}") from e
    ...
    def get_tasks(self) -> List["Task"]:
        """Get all tasks in this executable (just this task)."""
        return [self]

    def get_task_ids(self) -> Set[str]:
        """Get all task IDs in this executable (just this task's ID)."""
        return {self.task_id}
